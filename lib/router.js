...
Router.onBeforeAction(mustBeSignedIn, {
    except: ['entrySignIn', 'entrySignUp', 'entryForgotPassword', 'entryResetPassword', 'entryError', 'layout', 'token', 'home', 'search', 'resto', 'createPlace', 'createOrder']
});
...
Router.map( function () {
  ...
  this.route('editPlace', {
    path: '/edit/:_id',
    onBeforeAction: function() {
      Meteor.subscribe('TheTags', 'Places');
    },
    data: function() {
      return Places.findOne({_id: this.params._id});
    }
